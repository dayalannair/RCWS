...
function safety = process_trig_sweep(i_data,q_data)
    ...
    % Extract and combine IQ
    iq_u = i_data(1:200) + 1i*q_data(1:200);
    iq_d = i_data(201:400) + 1i*q_data(201:400);
    ...
    rg_array = zeros(nbins);
    fd_array = zeros(nbins);
    sp_array = zeros(nbins);
