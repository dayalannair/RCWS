...
errorbar(x,z,'Color','r',LineWidth=1.1 ,DisplayName="GPS")
plot(x,'-o','Color','b','LineWidth',0.6,'MarkerFaceColor','b' , DisplayName="Radar")
caxis([0, 62.5]);
% scatter(x,y,5,'b','filled' ,DisplayName="Radar")
legend('FontSize',13)