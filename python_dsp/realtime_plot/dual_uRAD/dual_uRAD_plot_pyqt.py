...
plot1 = pg_layout.addPlot(x=rng_ax, y=fftu, pen='r', symbol='x', row=0, col=0, title="Plot @ row 1, column 1")
plot2 = pg_layout.addPlot(x=rng_ax, y=fftd, pen='r', symbol='x', row=0, col=1, title="Plot @ row 1, column 2")
