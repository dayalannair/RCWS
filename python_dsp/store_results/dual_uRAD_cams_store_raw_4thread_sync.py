...
try:
	stop = 0
	# Camera threads
	vid1 = threading.Thread(target=capture, args=[sweeps, cap1, out1, stop])
	vid2 = threading.Thread(target=capture, args=[sweeps, cap2, out2, stop])
	# uRAD threads
	rpi_urad = threading.Thread(target=rpi_urad_capture, args=[sweeps])
	usb_urad = threading.Thread(target=usb_urad_capture, args=[sweeps])
