...
line1_pi, = ax[0].plot(rng_ax, fftu)
line2_pi, = ax[0].plot(rng_ax, upth)
line3_pi, = ax[1].plot(rng_ax, fftd)
line4_pi, = ax[1].plot(rng_ax, dnth)
...
try:
	for i in range(sweeps):
		...
		os_pku_pi, os_pkd_pi, upth_pi, dnth_pi, fftu_pi, fftd_pi, safety_inv_pi[i], beat_index_pi, beat_min_pi, rg_array_pi, sp_array_pi = py_trig_dsp(I,Q)
